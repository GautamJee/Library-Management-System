...
<form class="form" method="post" action="<?php $_PHP_SELF ?>" id="modifystudent" />
    <label class="textbox">Updating Student's Detail</label><br/>
    ...
    <input class="search-form-button" type="submit" onclick="return confirm ('Confirm to Modify Student Details ?')" name="submit" value="Update"/>
...
<div class="floatinglinks" >
        <a target="_blank" href="/students/contact/add/">Add Contact</a><br/>
        <a target="_blank" href="/students/contact/update/">Update Contact</a><br/>
        <a target="_blank" href="/students/contact/remove/">Remove Contact</a>
</div>
<?php
