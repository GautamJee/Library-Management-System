...
<form class="form" method="post" action="<?php $_PHP_SELF ?>" id="modifymagazine" >
    <label class="textbox">Modify Magazine Detail</label><br/>
    <input class="search-form-input" type="number" name="id" placeholder="magazine id" /><br/>
