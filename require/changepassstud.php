...
if($_SESSION['user']=='student')
{
    ...
    <form class="form" method="post">
        ...
        <input class="search-form-button" class="button" type="submit" name="submit" value="Change Now">
    </form>';
}
?>
<?php 
if($_POST['pass1'] && $_POST['pass2']){
    ...
    else
    {
        ...
        $query="update student_login set pass='".$_POST['pass1'] ."' where logid=".$_SESSION['logid'].";";
        connect();
        tableprint($query);
