...
<form class="form pagecenter" method="post" action="<?php $_PHP_SELF  ?>" id="addjournal" >
    <label class="textbox">Add New Journal</label><br/>
    ...
    <input class="search-form-button" type="submit" onclick="return confirm  ('Confirm to Add the journal ?')"  name="submit" value="Add"/>
